...
user=$(whoami)
LS="#[fg=$G04,bg=$TC,bold] $user_icon#{pad} $user@#h #[fg=$TC,bg=$G06,nobold]$rarrow#[fg=$TC,bg=$G06] $session_icon#{pad} #S "
...
RS="#[fg=$G06]$larrow#[fg=$TC,bg=$G06] $time_icon $time_format #[fg=$TC,bg=$G06]$larrow#[fg=$G04,bg=$TC] $date_icon#{pad} $date_format #{pad} "
